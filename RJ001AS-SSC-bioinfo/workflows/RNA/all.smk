...
rule all:
    input:
        ...
        expand(os.path.join(out_dir, "results", "{sample_name}_Fusion.xls"), sample_name=sample_name_list),
        expand(os.path.join(out_dir, "results", "{sample_name}_RNA_QC.xls"), sample_name=sample_name_list)


include: "trim.smk"
include: "bwa.smk"
include: "bam_filter.smk"
include: "anno.smk"
include: "qc_stat.smk"
include: "clear.smk"